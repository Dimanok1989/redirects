...
class UpdateRedirectBadLinksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('redirect_bad_links', function (Blueprint $table) {
            $table->string('referer_host', 250)->nullable()->comment('Хост реферальной ссылки')->after('shortlink');
